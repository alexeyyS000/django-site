...
class DetailTestPollView(View):
    ...
    def get(self, request: HttpRequest, test_number, poll_number) -> HttpResponse:
        ...
        context = {'question':this_poll, 'all_polls_list':all_polls_list, 'test_number':test_number, 'is_complete_question':is_complete_question}
...
def vote(request, test_number, poll_number):
    ...
    return HttpResponseRedirect(reverse("polls:firstquestion" ,kwargs={'test_number':test_number,'poll_number':poll_number}))
